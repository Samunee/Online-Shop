                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <span class="float-right">
                                Sort Price: <a href="<?= base_url('shop/sortby/asc') ?>"
                                    class="badge badge-primary">Cheapest</a> | <a
                                    href="<?= base_url('shop/sortby/desc') ?>" class="badge badge-primary">Most
                                    Expensive</a>
                            </span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-3">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item"><a href="<?= base_url('home') ?>">All Category</a></li>
