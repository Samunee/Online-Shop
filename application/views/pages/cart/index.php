        ...
        <div class="col-md-12">
            <div class="card mb-3">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('checkout') ?>" class="btn btn-success float-right">Payment <i class="fas fa-angle-right"></i></a>
                    <a href="<?= base_url('home') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"></i> Back to Shopping</a>
                </div>
            </div>
        </div>
    </div>
